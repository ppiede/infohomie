...
export function getRandomValues() {
  let randFeatureOne =
    defaultFeatures["featureOne"]["values"][Math.round(Math.random())];
  let randFeatureTwo =
    defaultFeatures["featureTwo"]["values"][Math.round(Math.random())];
  let randFeatureThree =
    defaultFeatures["featureThree"]["values"][Math.round(Math.random())];
  let randFeatureFour =
    defaultFeatures["featureFour"]["values"][Math.round(Math.random())];
  return {
